      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
        <div class="relative">
          <div class="grid grid-cols-2 gap-4">
            <div 
              v-for="(hero, index) in featuredHeroes.slice(0, 4)" 
              :key="hero.id"
            ...
            >
              <div class="text-center">
                <div class="w-16 h-16 mx-auto mb-2 bg-gradient-to-r from-orange-400 to-red-400 rounded-full flex items-center justify-center shadow-md">
                  <span class="material-icons text-white text-3xl">local_police</span>
                </div>
                <h4 class="text-md font-bold text-white">{{ hero.name }}</h4>
                <p class="text-xs text-gray-400">{{ hero.category }}</p>
              </div>
            </div>
          </div>
          <div class="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-orange-700">
            ...
            <div class="text-center transform hover:scale-110 transition-transform duration-300" data-aos="fade-up" data-aos-delay="100">
              <div class="text-2xl font-bold text-yellow-400">50+</div>
              <div class="text-gray-300 text-sm">قصة تفاعلية</div>
            </div>
            <div class="text-center transform hover:scale-110 transition-transform duration-300" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="text-right">
          <div class="space-y-6">
            <div class="flex items-start gap-4 transform hover:translate-x-2 transition-transform duration-300" data-aos="fade-left">
            ...
            <div class="flex items-start gap-4 transform hover:translate-x-2 transition-transform duration-300" data-aos="fade-left" data-aos-delay="100">
            ...
            <div class="flex items-start gap-4 transform hover:translate-x-2 transition-transform duration-300" data-aos="fade-left" data-aos-delay="200">

          ...
          <div class="flex gap-6">
            ...
            <div class="flex-grow text-right">
              <div class="flex items-start justify-between mb-3">
                ...
                <span class="flex items-center gap-1 bg-amber-900 text-amber-200 px-2 py-1 rounded-full text-sm shadow transform group-hover:scale-110 transition-transform">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-4 text-sm text-gray-400">
                  <span class="bg-amber-900 text-amber-300 px-2 py-1 rounded transform group-hover:scale-105 transition-transform">
                    {{ content.category }}
                  </span>

  ...
  <section class="py-20 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <SectionsContentCard v-for="content in latestContents" :key="content.id" :content="content"
          :getContentTypeIcon="getContentTypeIcon" :isNewContent="isNewContent" :formatDate="formatDate"

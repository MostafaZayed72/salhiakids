        ...
        <Transition name="custom-slide-down">
            <div v-if="showFilterDropdown" class="mt-4 bg-white border border-gray-200 rounded-xl shadow-xl text-right p-4">
                ...
                <select 
                    ...
                    class="w-full border border-gray-300 rounded-lg p-2 bg-white focus:ring-purple-500 focus:border-purple-500 transition-colors"
                >
...
try {
 ...
 stories.value = data.items;
   ...
   // تحديث متغيرات الإحصائيات (نفترض أن الـ API يرجعها ضمن الـ payload الرئيسي)
...
// ------------------------------------------------------------------
// 5. التنفيذ والمراقبة (تم إكمال هذا القسم)
// ------------------------------------------------------------------
